<%@ Page Language="C#" MasterPageFile="~/Site.Master" Title="Faculty Setup" AutoEventWireup="true" CodeBehind="SetupFaculty.aspx.cs" Inherits="AttendanceSystem.SetupFaculty" %>
    ...
    <div class="row">
                        ...
                        <table id="table" class="table table-striped table-bordered second" style="width: 100%">
                            ...
                            <tbody style="width: 100%">
                                          ...
                                          <asp:HiddenField ID="Facid" runat="server" />
          ...
          <script src="Scripts/Attendance/SetupFaculty.js"></script>
