    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                id = Data["deptid"]
                document.getElementById("MainContent_txtdeptname").value = Data["name"];

                document.getElementById("MainContent_deptid").value = id;
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Result = confirm("You are about to delete Department of " + name)
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/attendance/DeleteDept?id= " + ID + "",
        success: function (data) {
