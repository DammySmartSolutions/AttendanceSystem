...
function LoadDataTable() {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/attendance/LoadFaculty",
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                document.getElementById("MainContent_Facid").value = id;

               

                Mainform.Facid.value = id
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Result = confirm("You are about to delete Faculty of " + name)
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/attendance/DeleteFaculty?id= " + ID + "",
        success: function (data) {
