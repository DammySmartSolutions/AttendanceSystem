...
function LoadDataTable() {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/attendance/LoadCourseRegistration",
        success: function (data) {
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Result = confirm("You are about to delete " + code + " course registration for " + name);
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/attendance/DeleteCourseRegister?id= " + ID + "",
        success: function (data) {
            alert(" Course  Registration  Deleted! ");
            ID = 0;
            LoadDataTable();
