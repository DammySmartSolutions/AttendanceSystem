<%@ Page Language="C#"  MasterPageFile="~/Site.Master" Title="Course Allocation" AutoEventWireup="true" CodeBehind="CourseAllocation.aspx.cs" Inherits="AttendanceSystem.CourseAllocation" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
                                            ...
                                            <asp:DropDownList ID="ddlcode"  runat="server"   CssClass="form-control form-control-sm" >    
                                             ...
                                             <div class="col-sm-6">
                                                 ...
                                                 <div class="form-group">
                                                                          ...
                                                                          <label for="ddlstaffid" class="col-form-label">Instructor</label>
          ...
          <script src="Scripts/Attendance/CourseAllocation.js"></script>
