<%@ Page Language="C#" MasterPageFile="~/Site.Master" Title="Venue Setup" AutoEventWireup="true" CodeBehind="SetupVenue.aspx.cs" Inherits="AttendanceSystem.SetupVenue" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
                       ...
                       <asp:ScriptManager ID="ScriptManager1" runat="server">
                                       ...
                                       <%--  <asp:UpdatePanel ID="upSetSession" runat="server">
                                         ...
                                         <div class="row">
                                             <div class="col-sm-6">
                                                ...
                                                <label for="txtname" class="col-form-label">Venue</label>
                                             ...
                                             <div class="col-sm-6">
                                                 ...
                                                 <div class="form-group">
                                                      ...
                                                      <label for="ddlfaculty" class="col-form-label">Faculty</label>
                        ...
                        <table id="table" class="table table-striped table-bordered second" style="width: 100%">
                            ...
                            <tbody style="width: 100%">
                                          ...
                                          <asp:HiddenField ID="venid" runat="server" />
          ...
          <script src="Scripts/Attendance/SetupVenue.js"></script>
